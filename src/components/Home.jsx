        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {MODULES.map((mod, i) => (
            <button
              ...
              className="text-left rounded-2xl border border-white/10 bg-panel p-6 hover:border-nebula hover:shadow-glow hover:-translate-y-0.5 transition-all duration-200"
            >
              <div className="flex items-center justify-between mb-2">
                <ModuleGlyph kind={mod.key} />
                <div className="text-starlight text-xs font-mono">
